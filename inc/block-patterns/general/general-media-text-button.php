...
<div class="wp-block-media-text alignwide has-media-on-the-right is-stacked-on-mobile is-image-fill is-style-default has-senary-background-color has-background">
	...
	<div class="wp-block-media-text__content">
		<!-- wp:heading {"level":6,"backgroundColor":"secondary","style":{"spacing":{"margin":{"bottom":"0"}}}} -->
		<h6 class="has-secondary-background-color has-background" style="margin-bottom:0;">Hammarby Kaj 10</h6>
		<!-- /wp:heading -->
